...
define( 'ROOT_DIR', realpath( APPLICATION_PATH . '../public_html' ) );
...
define( 'CAPTCHA_URL', ROOT_DIR  );
define( 'CAPTCHA_PATH', ROOT_DIR  );
...
if (class_exists( 'PDO' )) {
	try {
		$pdo = new PDO( 'mysql:host=127.0.0.1;dbname=racehors_racehors', 'racehors_racehor', 'lr4XZC2EEK7M' );
	...
	$conn = Doctrine_Manager::connection( 'mysql://racehors_racehor:lr4XZC2EEK7M@127.0.0.1/racehors_racehors' );
}
