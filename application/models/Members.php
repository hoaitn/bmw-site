...
class Members extends BaseMembers {
	...
	public static function getAll($Condition = array(), $currentPage = 1, $recordPerPage = 1, $orderBy = 'id DESC') {
	...
	public function getCreatedDate() {
		return date ( 'Y-m-d H:i', strtotime ( $this->created_date ) );
	}
	public function getLastLogin() {
		return ($this->last_login) ? date ( 'Y-m-d H:i', strtotime ( $this->last_login ) ) : '-';
	}
